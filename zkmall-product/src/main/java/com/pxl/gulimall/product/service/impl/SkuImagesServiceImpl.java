...
import com.pxl.zkmall.product.dao.SkuImagesDao;
import com.pxl.zkmall.product.entity.SkuImagesEntity;
import com.pxl.zkmall.product.service.SkuImagesService;
...
public class SkuImagesServiceImpl extends ServiceImpl<SkuImagesDao, SkuImagesEntity> implements SkuImagesService {
    ...
    public List<SkuImagesEntity> getImageBySkuId(Long skuId) {
        List<SkuImagesEntity> imagesEntities = this.baseMapper
